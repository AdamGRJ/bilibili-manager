...
CREATE TABLE `favorites` (
  ...
  CONSTRAINT `favorites_ibfk_2` FOREIGN KEY (`video_id`) REFERENCES `videos` (`id`) ON DELETE CASCADE
...
CREATE TABLE `video_history` (
  ...
  PRIMARY KEY (`id`),
  KEY `video_id` (`video_id`),
  CONSTRAINT `video_history_ibfk_1` FOREIGN KEY (`video_id`) REFERENCES `videos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `video_history` WRITE;
...
-- Dump completed on 2025-03-13 11:19:00
